...
namespace WindowsApp3Asteroids
{
    ...
    internal class Game
    {
        ...
        private static void Draw()
        {
            ...
            if (ship != null)
                _buffer.Graphics.DrawString($"Количество очков: {ship.Score}", new Font(FontFamily.GenericSansSerif, 14), Brushes.YellowGreen, 760,10);
            foreach (var bullet in bullets)
